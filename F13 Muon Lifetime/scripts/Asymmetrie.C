		...
		const char *mitBfile = "fp13mitB.root")
{
	...
	ho->Add(a[1], 1.0); hu->Add(b[1], 1.0); //addition von b[1]
	...
	// dann mit B-Feld
	hmo->Add(am[1], 1.0);   hmu->Add(bm[1], 1.0); //addition von b[1]
