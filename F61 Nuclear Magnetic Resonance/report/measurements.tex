...
\label{table1}
\end{table}\\
We can see 3 relations from these measurements: $T_{1} > T_{2}$ and $T_{2,CP} > T_{2,SE}$ for both substances as well as $T_{600} > T_{500}$ for each different method. The first can explained by %TODO .
...
The third relation can be attributed to the fact that the Ga 500 has higher concentration which leads to a more %TODO .
\vspace{2mm}\\
